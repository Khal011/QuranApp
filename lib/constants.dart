// ignore_for_file: await_only_futures, prefer_typing_uninitialized_variables, non_constant_identifier_names
...
var screens = [HomeScreen, SalatScreen, QuranScreen, QiblaScreen];
var size = WidgetsBinding.instance.platformDispatcher.views.first.physicalSize;
var lightbrown = const Color.fromARGB(255, 243, 241, 229);
var purple = const Color(0xffac527f);
var yellow = Colors.amber;
var mediumbrown = const Color(0xFF645D4D);
var darkestbrown = const Color(0xFF211E18);

var getlocvar = getloc();
String globalLoc = "Unknown";
Uri quranAppUrl = Uri.parse("https://github.com/Khal011");
